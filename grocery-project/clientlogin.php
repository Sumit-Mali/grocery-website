    ...
    <div>
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="index.php" class="h1"><b>Client Login</b></a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Sign in to start your session</p>

                <form id="vlogin-frm" action="client\validation.php" method="post">
                    ...
                    <div class="row align-item-end">
                        ...
                        <div class="col-12 text-center">
                            <a href="clientregister.php" style="text-decoration: none;">Create an Account</a>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
