...
<head>
    ...
    <style>
        ...
        .section-products #product-1 .part-1::before {
            background: url("../images/mango.jpg") no-repeat center;
        ...
        .section-products #product-3 .part-1::before {
            background: url("../images/apples.jpg") no-repeat center;
            background-size: cover;
        }
        ...
        .section-products #product-5 .part-1::before {
            background: url("../images/beans.jpg") no-repeat center;
            background-size: cover;
            transition: all 0.3s;
        }

        .section-products #product-6 .part-1::before {
            background: url("../images/bringle.jpg") no-repeat center;
            background-size: cover;
        }

        .section-products #product-7 .part-1::before {
            background: url("../images/tomato.jpg") no-repeat center;
            background-size: cover;
        }

        .section-products #product-8 .part-1::before {
            background: url("../images/chilli.jpg") no-repeat center;
            background-size: cover;
        }
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item active" href="..\products\FandV.php"
                                    style="background-color: #343a40;">Fruits and Vegetables</a></li>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../images/FandVbanner1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../images/FandVbanner2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../images/FandVbanner3.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-1" class="single-product">
                        ...
                        <div class="part-2">
                            ...
                            <h4 class="product-old-price"><i class="fa-solid fa-indian-rupee-sign"></i>800</h4>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-2" class="single-product">
                        ...
                        <div class="part-2">
                            <h3 class="product-title">Water-Melon</h3>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-4" class="single-product">
                        ...
                        <div class="part-2">
                            ...
                            <h4 class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i>60</h4>
                        </div>
                    </div>
                </div>
                <!-- Single Product -->
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-5" class="single-product">
                        ...
                        <div class="part-2">
                            ...
                            <h4 class="product-old-price"><i class="fa-solid fa-indian-rupee-sign"></i>80</h4>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-6" class="single-product">
                        ...
                        <div class="part-2">
                            <h3 class="product-title">Bringal</h3>
                            <h4 class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i>60</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-7" class="single-product">
                        ...
                        <div class="part-2">
                            ...
                            <h4 class="product-old-price"><i class="fa-solid fa-indian-rupee-sign"></i>50</h4>
                            <h4 class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i>30</h4>
                        </div>
                    </div>
                </div>
                <!-- Single Product -->
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-8" class="single-product">
                        ...
                        <div class="part-2">
                            <h3 class="product-title">Chili</h3>
                            <h4 class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i>50</h4>
                        </div>
                    </div>
                </div>
